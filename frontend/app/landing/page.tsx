...
import { ThemeProvider, Button, Card, LayoutGrid } from '../../components'
          ...
          <aside>
            <Card>
              <div style={{width:'100%',height:420,display:'flex',alignItems:'center',justifyContent:'center',background:'linear-gradient(180deg, rgba(255,255,255,0.02), rgba(0,0,0,0.02))',borderRadius:12}}>
                <img src="/images/demo-mock.png" alt="Workspace mock" style={{maxWidth:'100%',maxHeight:'100%',objectFit:'contain'}} />
              </div>
            </Card>
          </aside>
        </section>
        ...
        <section style={{marginTop:64}}>
          ...
          <div style={{marginTop:28}}>
            <LayoutGrid columns={4} gap={20}>
              ...
              <Card>
                <img src="/images/demo-mock.png" alt="Workspace demo" style={{width:32,height:32,marginBottom:12}} />
                <h3>Demo preview</h3>
